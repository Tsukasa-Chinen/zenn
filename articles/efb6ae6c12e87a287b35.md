...
調べてみたところブラウザ上のコードエディターでも編集できるようですが、やはり使い慣れたエディターを使って作業した方が効率がいいと感じたので、開発環境をローカルに構築してみました。
今回はローカルへの環境構築の方法と**Shopifyのコマンド**を紹介します。
...
/*
　設定例：
　API パスワード： shppa_z987654321
　ストアURL： hoge.myshopify.com
　テーマID： 115540426945
*/
theme get -p=shppa_z987654321 -s=hoge.myshopify.com -t=11554042694
```
...
　テーマ名： myTheme
*/
theme new -p=shppa_z987654321 --store=hoge.myshopify.com --name=myTheme
```
...
```
theme get --list -p=shppa_z987654321 -s=hoge.myshopify.com
```
